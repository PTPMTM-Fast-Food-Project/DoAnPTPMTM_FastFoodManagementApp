...
//        public bool ExportOrder(List<OrderDTO> dataSource, ref string fileName, bool isPrintPreview)
//        {
...
//            // Set the order numbers (STT)
//            for (int i = 0; i < dataSource.Count; i++)
//            {
//                dataSource[i].STT = (i + 1).ToString(); // Gán STT từ 1 đến n
//            }

//            // Calculate total quantity
//            string totalQuantity = dataSource.Sum(t => t.total_price).ToString();

//            // Create a replacer dictionary
//            Dictionary<string, string> replacer = new Dictionary<string, string>
//            {
//                { "V_TONGSO", totalQuantity }
//            };

//            // Build the current date replacer
